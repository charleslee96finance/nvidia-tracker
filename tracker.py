...
/* Mid-weight glass for the bulk of the surfaces */
...
<div class="wrap">
  ...
  <div class="plugin-grid">
    ...
    <a href="./engagement.html" target="_blank" class="plugin-card" style="background:linear-gradient(135deg,var(--bg2) 0%,rgba(77,166,255,0.06) 100%);border-color:rgba(77,166,255,0.22)">
      <div class="plugin-icon">📈</div>
      <div class="plugin-body">
        <div class="plugin-name">页面互动分析 <span class="plugin-tag" style="background:rgba(77,166,255,0.18);color:var(--blue)">ENGAGEMENT</span></div>
        <div class="plugin-desc">各页面互动 · 每周对比 · 完播率 · 占比图表</div>
      </div>
